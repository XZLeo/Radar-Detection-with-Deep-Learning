'''
From https://github.com/XZLeo/radar_scenes/blob/master/radar_scenes/labels.py
Map 11 classes to 5 classes
'''
...
class ClassificationLabel(Enum):
    ...
    def translation_dict() -> dict:
        ...
        return {
            ...
            Label.ANIMAL: ClassificationLabel.STATIC, #
            Label.OTHER: ClassificationLabel.STATIC, #
